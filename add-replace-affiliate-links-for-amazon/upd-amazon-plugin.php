...
Version: 1.0.6
Author: The Website Flip
Author URI: https://thewebsiteflip.com
...
function uralp_upd_amazon_setup_menu() {
	add_menu_page(
		'Add & Replace Amazon Affiliate Links', 'Add & Replace Amazon Affiliate Links', 
		'manage_options', 'uralp-upd-amazon-plugin', 'uralp_init_page', 'dashicons-update-alt'
	);
	add_submenu_page(
		'uralp-upd-amazon-plugin', 'Update Links', 'Update Links', 
